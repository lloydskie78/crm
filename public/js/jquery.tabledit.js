...
(function($) {
    ...
    $.fn.Tabledit = function(options) {
        ...
        if (settings.deleteButton) {
             ...
             * @param {object} event
             */
            $table.on("click", "button.tabledit-delete-button", function(
                event
            ) {
             ...
             * @param {object} event
             */
            $table.on("click", "button.tabledit-confirm-button", function(
                event
            ) {
                if (event.handled !== true) {
                    event.preventDefault();
        ...
        if (settings.restoreButton) {
             ...
             * @param {object} event
             */
            $table.on("click", "button.tabledit-restore-button", function(
                event
            ) {
                if (event.handled !== true) {
                    event.preventDefault();
